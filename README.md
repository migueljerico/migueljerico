...
[![GitHub Developer Program](https://img.shields.io/badge/GitHub-Developer%20Program-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/migueljerico)
...
| :--- | :--- | :--- | :--- |
| **🚀 Data & IA Aplicada** | 🚀 [DataFlow AI](https://github.com/migueljerico/dataflow-ai) · [🌐 Demo](https://dataflow-ai-748914382449.us-central1.run.app) | Plataforma integral de preparación, calidad y analítica de datos empresariales. Transforma datos crudos heterogéneos en datasets limpios y gobernados para Power BI mediante Data Profiling, Data Quality Score (5 dimensiones), motor ETL determinista en Python/pandas, Copiloto IA con guardrails estrictos (Gemini BYOK) y cálculo de KPIs de negocio en tiempo real. | Python, FastAPI, Pandas, React, TypeScript, Gemini, Docker, Cloud Run |
